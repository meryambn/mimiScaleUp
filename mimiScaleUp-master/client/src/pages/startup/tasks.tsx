...
const TasksPage: React.FC = () => {
  ...
  const { selectedProgram, isLoading, error, programs, setSelectedProgram } = useProgramContext();
  ...
  // Effect to update selected program when URL changes
  useEffect(() => {
    if (programId) {
  ...
  }, [programId, programs, setSelectedProgram]);
  ...
  if (isLoading) {
    return (
      <div className="container mx-auto py-6" style={{ marginLeft: '290px', width: 'calc(100% - 290px)' }}>
      ...
      <div className="container mx-auto py-6" style={{ marginLeft: '290px', width: 'calc(100% - 290px)' }}>
        <div className="flex justify-center items-center h-64">
          <div className="text-center">
            ...
            <h3 className="mt-2 text-lg font-medium text-gray-900">Aucun programme sélectionné</h3>
            <p className="mt-1 text-sm text-gray-500">
              Veuillez sélectionner un programme pour voir ses tâches.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="container mx-auto py-4 mt-[70px]" style={{ marginLeft: '290px', width: 'calc(100% - 290px)' }}>
      <div className="flex justify-between items-center mb-4">
        <div>
          <h1 className="text-xl font-bold">Tâches du programme</h1>
      ...
      <Card className="mb-4">
        <CardHeader className="pb-1">
          <CardTitle className="text-base">Chronologie des phases du programme</CardTitle>
          <CardDescription className="text-sm">Cliquez sur une phase pour filtrer les tâches</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <TabsContent value="all">
          {filteredTasks.length === 0 ? (
            <div className="text-center py-8 bg-gray-50 rounded-lg">
              ...
              <h3 className="mt-2 text-base font-medium text-gray-900">Aucune tâche trouvée</h3>
              <p className="mt-1 text-sm text-gray-500">
                {selectedPhase
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  <div className="flex items-center mb-2">
                    ...
                    <h2 className="font-medium text-sm">À faire</h2>
                  </div>
                  <Droppable droppableId="todo">
                    {(provided) => (
                      <div
                        ...
                        className="bg-gray-50 rounded-lg p-2 min-h-[250px]"
                      >
                ...
                <div>
                  <div className="flex items-center mb-2">
                    ...
                    <h2 className="font-medium text-sm">En cours</h2>
                  </div>
                ...
                <div>
                  <div className="flex items-center mb-2">
                    ...
                    <h2 className="font-medium text-sm">Terminé</h2>
                  </div>
