...
const ParticulierDeliverablesPage = () => {
  ...
  const requiredDocuments = {
    1: ["CV", "Lettre de motivation", "Diplômes"],
    2: ["Rapport d'expérience", "Portfolio", "Références"],
    3: ["Rapport de stage", "Présentation finale", "Feedback"],
    4: ["Rapport final", "Certificat de formation", "Évaluation"]
  };
      ...
      <main className="main-content">
        ...
        <header className="deliverables-header">
          <div>
            ...
            <p className="subtitle">Documents à soumettre pour votre parcours</p>
          </div>
          <motion.button
